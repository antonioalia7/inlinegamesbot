...
class Elephantxo extends Tictactoe
{
     ...
     * @var string
     */
    protected static $title = 'Tris 8x8';
     ...
     * @var string
     */
    protected static $description = 'Tris 8x8 Elephant XO è un gioco per due giocatori, X e O, che a turno segnano gli spazi in una griglia 8×8.';
